    ...
    'stickers' => [
        ...
        'items' => [
            'die-cut-stickers' => [
                ...
                'icon' => 'products/stickers/die-cut-stickers.png',
                'active' => 1, 
                'short-description' => 'Die-cut stickers, uniquely shaped and designed, serve a variety of purposes—from product labeling to promotional giveaways.',
                ...
                'max-height' => 24,
                'min-quantity' => 10,
                'allow-custom-size' => true,
                'allow-custom-quantity' => true,
                'max-quantity' => 200000
            ],
            'circle-stickers' => [
                'name' => 'Circle sticker',
                'icon' => 'products/stickers/circle-stickers.png',
                'active' => 1, 
                'short-description' => 'Circular stickers, uniquely shaped and tailored for custom designs, are versatile for product labeling, marketing, decor, or giveaways.',
            ...
            'rectangle-stickers'  => [
                ...
                'active' => 1, 
                'icon' => 'products/stickers/rectangle-stickers.png',
                'short-description' => 'Rectangle stickers, featuring a classic shape, are versatile for product labels, marketing, decor, or giveaways.',
            ...
            'square-stickers'  => [
                ...
                'active' => 1, 
                'icon' => 'products/stickers/square-stickers.png',
                'short-description' => 'Square stickers, with their timeless design, are versatile for product labels, marketing, decor, or giveaways.',
            ...
            'oval-stickers'  => [
                'name' => 'Oval stickers',
                'active' => 1, 
                'icon' => 'products/stickers/oval-stickers.png',
                'short-description' => 'Oval stickers, distinguished by their unique and curved design, provide versatility for product labels, marketing initiatives, decor, or giveaways.',
            ...
            'bumper-stickers'  => [
                ...
                'active' => 1, 
                'icon' => 'products/stickers/bumper-stickers.png',
                'short-description' => 'Bumper stickers, designed for durability and impact, are ideal for expressing messages on-the-go.',
            ...
            'sticker-sheets'  => [
                'name' => 'Sticker sheets',
                'active' => 1, 
                'icon' => 'products/stickers/sticker-sheets.png',
                'short-description' => 'Sticker sheets, a versatile platform for creative expression, house multiple uniquely shaped and designed stickers on a single sheet.',
            ...
            'kiss-cut-stickers'  => [
                ...
                'active' => 1, 
                'icon' => 'products/stickers/kiss-cut-stickers.png',
                'short-description' => 'Kiss-cut stickers, precision-crafted for versatility, offer a unique way to showcase designs or messages.',
            ...
            'round-corner-stickers'  => [
                ...
                'active' => 1,
                'icon' => 'products/stickers/round-corner-stickers.png',
                'short-description' => 'Round corner stickers, designed with a touch of sophistication, provide a sleek and polished look for various applications.', 
            ...
            'clear-stickers'  => [
                'name' => 'Clear stickers',
                'active' => 1, 
                'icon' => 'products/stickers/clear-stickers.png',
                'short-description' => 'Clear stickers, with their transparent allure, offer a subtle and modern way to showcase your designs or messages.',
            ...
            'transfer-stickers'  => [
                ...
                'active' => 1, 
                'icon' => 'products/stickers/transfer-stickers.png',
                'short-description' => 'Transfer stickers, designed for seamless application, provide a convenient way to transfer intricate designs onto surfaces with precision.',
                ...
                'default-quantity' => [1, 10, 50, 100, 200, 300, 500, 1000],
                'min-width' => 1,
                'min-height' => 1,
                'max-width' => 15,
                'discount-percentage' => 10,
            ...
            'vinyl-lettering'  => [
                ...
                'active' => 0, 
                'icon' => 'products/stickers/vinyl-lettering.png',
                'short-description' => 'Vinyl lettering, a sophisticated choice for personalized messaging, brings your words to life with precision and style.',
                ...
                'max-height' => null,
                'min-quantity' => null,
                'allow-custom-size' => false,
                'allow-custom-quantity' => false,
                'max-quantity' => 0
            ],
        ]
    ],
    'labels' => [
        ...
        'items' => [
            'die-cut-labels' => [
                'name' => "Die cut labels",
                'active' => 1, 
                'icon' => 'products/labels/die-cut-labels.png',
                'short-description' => 'Die-cut labels are custom-shaped, versatile solutions for branding and product labeling.',
            ...
            'clear-labels' => [
                'name' => "Clear labels",
                'active' => 1, 
                'icon' => 'products/labels/clear-labels.png',
                'short-description' => 'Clear labels, precision-cut into a classic and timeless shape, offer a versatile and visually appealing solution for various applications.',
            ...
            'circle-labels' => [
                'name' => "Circle labels",
                'active' => 1, 
                'icon' => 'products/labels/circle-labels.png',
                'short-description' => 'Circle labels, precision-cut into a classic and timeless shape, offer a versatile and visually appealing solution for various applications.',
            ...
            'square-labels' => [
                'name' => "Square labels",
                'active' => 1, 
                'icon' => 'products/labels/square-labels.png',
                'short-description' => 'Square labels, with their timeless design, provide a versatile and polished solution for branding and product labeling.',
            ...
            'rectangle-labels' => [
                ...
                'active' => 1, 
                'icon' => 'products/labels/rectangle-labels.png',
                'short-description' => 'Rectangle labels, with their clean and classic design, provide a versatile and polished solution for branding, packaging, and product labeling.',
            ...
            'rounded-corner-labels' => [
                ...
                'active' => 1, 
                'icon' => 'products/labels/rounded-corner-labels.png',
                'short-description' => 'Rounded corner labels, with their distinctive and sleek design, offer a unique and polished solution for branding and product labeling.',
            ...
            'oval-labels' => [
                'name' => "Oval labels",
                'active' => 1, 
                'icon' => 'products/labels/oval-labels.png',
                'short-description' => 'Oval labels, with their distinctive and sleek design, offer a unique and polished solution for branding and product labeling.',
            ...
            'circle-sheet-labels' => [
                ...
                'active' => 1, 
                'icon' => 'products/labels/circle-sheet-labels.png',
                'short-description' => 'Effortlessly brand your products and packaging with our circular sheet labels.',
            ...
            'die-cut-sheet-labels' => [
                ...
                'active' => 1, 
                'icon' => 'products/labels/die-cut-sheet-labels.png',
                'short-description' => 'Simplify your product branding and packaging with our die-cut sheet labels. Multiple die-cut labels on an 8.5” x 11” sheet ensure easy hand application.',
            ...
            'oval-sheet-labels' => [
                ...
                'active' => 1, 
                'icon' => 'products/labels/oval-sheet-labels.png',
                'short-description' => 'Elevate your product branding effortlessly with our oval sheet labels. Multiple ovals on an 8.5” x 11” sheet offer easy hand application.',
            ...
            'rectangle-sheet-labels' => [
                ...
                'active' => 1, 
                'icon' => 'products/labels/rectangle-sheet-labels.png',
                'short-description' => 'Streamline your product branding and labeling process with our rectangle sheet labels. Multiple rectangles on an 8.5” x 11” sheet make hand application a breeze.',
            ...
            'rounded-corner-sheet-labels' => [
                ...
                'active' => 1, 
                'icon' => 'products/labels/rounded-corner-sheet-labels.png',
                'short-description' => 'Effortlessly enhance your product branding and labeling with our rounded corner sheet labels. Featuring multiple labels on an 8.5” x 11” sheet, these rounded corners add a touch of sophistication.',
            ...
            'square-sheet-labels' => [
                ...
                'active' => 1, 
                'icon' => 'products/labels/square-sheet-labels.png',
                'short-description' => 'Simplify your product branding and labeling with our square sheet labels. Multiple squares on an 8.5” x 11” sheet ensure easy hand application.',
    ...
    'magnets' => [
        ...
        "items" => [
            'custom-magnets' => [
                'name' => "Custom magnets",
                'active' => 1, 
                'icon' => 'products/custom-magnets.png',
                'short-description' => 'Transform your space with our custom magnets, a unique and personalized touch for any occasion.',
    ...
    'custom-button' => [
        ...
        'items' => [
            '1-round-buttons' => [
                ...
                'active' => 1, 
                'icon' => 'products/round-button.png',
                'short-description' => 'Introducing our small custom round buttons – vibrant and versatile with full-color printing and a sturdy steel pin-back.',
            ...
            '125-round-buttons' => [
                ...
                'active' => 1, 
                'icon' => 'products/round-button.png',
                'short-description' => 'Introducing our 1.25” custom round buttons – vibrant and versatile with full-color printing and a sturdy steel pin-back.',
            ...
            '15-round-buttons' => [
                ...
                'active' => 1, 
                'icon' => 'products/round-button.png',
                'short-description' => 'Introducing our 1.5” custom round buttons – vibrant and versatile with full-color printing and a sturdy steel pin-back.',
            ...
            '225-round-buttons' => [
                ...
                'active' => 1, 
                'icon' => 'products/round-button.png',
                'short-description' => 'Introducing our 2.25” custom round buttons – vibrant and versatile with full-color printing and a sturdy steel pin-back.',
            ...
            'custom-pins' => [
                ...
                'active' => 1, 
                'icon' => 'products/round-button.png',
                'short-description' => 'Introducing our custom pins – vibrant and versatile with full-color printing and a sturdy steel pin-back.',
    ...
    'packaging' => [
        ...
        'items' => [
            'packaging-tapes' => [
                ...
                'active' => 1, 
                'icon' => 'products/packaging/packaging-tapes.png',
                'short-description' => 'Packaging tape is a type of adhesive tape specifically designed for sealing and securing packages. It plays a crucial role in packaging, ensuring that boxes and parcels are securely sealed during transit.',
                ...
                'allow-custom-size' => true,
                'allow-custom-quantity' => true,
                'max-quantity' => 1500000
            ],
            'poly-mailers' => [
                'name' => "Poly mailers",
                'active' => 1, 
                'icon' => 'products/packaging/poly-mailers.png',
                'short-description' => 'Poly mailers, also known as polyethylene mailers or plastic mailing bags, are lightweight and durable packaging envelopes made from polyethylene material.',
            ...
            'bubble-mailers' => [
                'name' => "Bubble mailers",
                'active' => 1, 
                'icon' => 'products/packaging/bubble-mailers.png',
                'short-description' => 'Bubble mailers, also known as bubble envelopes or padded mailers, are packaging envelopes designed for shipping and protecting items that require cushioning during transit.',
            ...
            'stand-up-punches' => [
                ...
                'active' => 1,
                'icon' => 'products/packaging/stand-up-punches.png', 
                'short-description' => 'Stand-up pouches are versatile and visually appealing packaging solutions commonly used across industries.',
    ...
    't-shirts' => [
        ...
        'items' => [
            'custom-prints-on-t-shirts' => [
                ...
                'active' => 1, 
                'icon' => 'products/t-shirts.png',
                'short-description' => 'Custom prints on T-shirts involve personalized designs, logos, or text applied to T-shirts through various printing techniques such as screen printing, direct-to-garment printing, or heat transfer.',
