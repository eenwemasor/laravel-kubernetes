...
return [
    ...
    'custom-button' => [
        ...
        'items' => [
            ...
            'cutton-round-buttons' => [
                'name' => "Cutton round buttons",
                'description' => "Introducing our custom round buttons – vibrant and versatile with full-color printing and a sturdy steel pin-back. Perfect for effortless wearing, distributing, or selling, these buttons are the ideal choice for organizations, businesses, bands, and events. Add a pop of color to your message and make a lasting impression with these portable and eye-catching accessories.",
                'unit-price' => 100
            ],
        ]
    ],
