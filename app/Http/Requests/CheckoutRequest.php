...
class CheckoutRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'billing_info.address_line'         => ['required', 'string'],
            'billing_info.company'              => ['string'],
            'billing_info.city'                 => ['required', 'string'],
            'billing_info.full_name'            => ['required', 'string'],
            'billing_info.phone_number'         => ['required', 'string'],
            ...
            'items.*.artwork_description'       => ['string'],
            ...
            'items.*.color'                     => ['string'],
            'items.*.sizes'                     => ['array'],
            'items.*.sizes.S'                   => ['integer'],
            'items.*.sizes.M'                   => ['integer'],
            'items.*.sizes.L'                   => ['integer'],
            'items.*.sizes.XL'                  => ['integer'],
            'items.*.sizes.2XL'                 => ['integer'],
            'items.*.sizes.2XL'                 => ['integer'],
        ];
    }
